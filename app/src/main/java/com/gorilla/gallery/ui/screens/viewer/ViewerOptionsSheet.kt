        ...
        Column(
            ...
            Row(
                ...
                Text(
                    ...
                    color = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black),
            ...
            LightweightGlassPanel(
                ...
                Column {
                    ...
                    HorizontalDivider(color = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black).copy(alpha = 0.06f), thickness = 1.dp)
                    ActionRow(
    ...
    LightweightGlassPanel(
        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    .size(34.dp)
                    .background((if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black).copy(alpha = 0.06f), RoundedCornerShape(10.dp))
                    .border(1.dp, (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black).copy(alpha = 0.08f), RoundedCornerShape(10.dp)),
                contentAlignment = Alignment.Center
            ) {
                Icon(icon, contentDescription = null, modifier = Modifier.size(16.dp), tint = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black))
            }
            Column(modifier = Modifier.weight(1f)) {
                Text(label, fontSize = 12.5.sp, fontWeight = FontWeight.Bold, color = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black), lineHeight = 14.sp)
                Text(sub, fontSize = 10.sp, fontWeight = FontWeight.Medium, color = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black).copy(alpha = 0.45f), modifier = Modifier.padding(top = 2.dp))
            }
        }
    }
}
    ...
    Row(
        ...
        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(12.dp), modifier = Modifier.weight(1f)) {
            Box(
                modifier = Modifier
                    .size(32.dp)
                    .background((if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black).copy(alpha = 0.05f), RoundedCornerShape(9.dp))
                    .border(1.dp, (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black).copy(alpha = 0.08f), RoundedCornerShape(9.dp)),
                contentAlignment = Alignment.Center
            ) {
                Icon(icon, contentDescription = null, modifier = Modifier.size(15.dp), tint = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black).copy(alpha = 0.85f))
            }
            Column {
                Text(label, fontSize = 13.5.sp, fontWeight = FontWeight.SemiBold, color = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black), lineHeight = 15.sp)
                Text(sub, fontSize = 10.5.sp, fontWeight = FontWeight.Medium, color = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black).copy(alpha = 0.42f), modifier = Modifier.padding(top = 2.dp))
            }
        }
        Icon(Icons.Rounded.ChevronRight, contentDescription = null, tint = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black).copy(alpha = 0.3f), modifier = Modifier.size(18.dp))
    }
}
    ...
    LightweightGlassPanel(
        ...
        Row(
            ...
            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(12.dp), modifier = Modifier.weight(1f)) {
                ...
                Column {
                    Text(title, fontSize = 13.5.sp, fontWeight = FontWeight.SemiBold, color = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black), lineHeight = 15.sp)
                    Text(sub, fontSize = 10.5.sp, fontWeight = FontWeight.Medium, color = (if (com.gorilla.gallery.ui.theme.LocalAppColors.current.isDark) Color.White else Color.Black).copy(alpha = 0.42f), modifier = Modifier.padding(top = 2.dp))
                }
            }
