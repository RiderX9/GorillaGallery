...
fun GorillaTheme(
    ...
    playerSliderStyle: com.gorilla.gallery.data.settings.PlayerSliderStyle = com.gorilla.gallery.data.settings.PlayerSliderStyle.DEFAULT,
    ...
    CompositionLocalProvider(
        ...
        LocalPlayerSliderStyle provides playerSliderStyle,
...
val LocalPlayerSliderStyle = staticCompositionLocalOf { com.gorilla.gallery.data.settings.PlayerSliderStyle.DEFAULT }
val LocalAppSettings = staticCompositionLocalOf<com.gorilla.gallery.data.settings.AppSettings> { error("No settings") }
